            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center pt-3">
                ...
                <div className="flex gap-3 mb-1">
                  <motion.div animate={isBlinking ? { scaleY: 0.1 } : { scaleY: 1 }} transition={{ duration: 0.1 }}>
                    <div className="w-9 h-10 bg-white rounded-full flex items-center justify-center overflow-hidden shadow-inner border-2 border-green-100">
                      <motion.div animate={open ? { x: [-1, 1, -1, 0] } : { x: 0 }} className="w-6 h-6 bg-emerald-600 rounded-full">
                ...
                <div className="absolute top-16 left-4 w-4 h-3 bg-pink-400/70 rounded-full blur-sm" />
                <div className="absolute top-16 right-4 w-4 h-3 bg-pink-400/70 rounded-full blur-sm" />

                {expression === "happy" && (
                  <motion.div animate={{ scaleX: [1, 1.1, 1] }} transition={{ duration: 2, repeat: Infinity }}>
                    <div className="w-8 h-4 bg-pink-400 rounded-full border-2 border-pink-500" />
                  </motion.div>
                )}
                {expression === "excited" && (
                  <div className="w-8 h-7 bg-pink-400 rounded-full border-2 border-pink-500 overflow-hidden">
                    <div className="w-full h-3 bg-pink-300 rounded-t-full" />
                  </div>
                )}
                {expression === "winking" && (
                  <div className="flex items-center gap-1">
                    <div className="w-6 h-3 bg-pink-400 rounded-full border-2 border-pink-500" />
