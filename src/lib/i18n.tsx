...
const dictionaries: Record<LangCode, Dict> = {
  en: {
    ...
    "price.one.t": "One-time consult", "price.one.p": "$7", "price.one.d": "Single deep diagnosis · no subscription · keep your history",
    "price.month.t": "Monthly", "price.month.p": "$12/mo", "price.month.d": "5 consults / month · ad-free · priority models",
    "price.cta": "Get started", "price.popular": "Most popular",
    "disclaimer": "DoctorsCon provides educational information only and is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician.",
  ...
  ar: {
    ...
    "price.one.t": "استشارة لمرة واحدة", "price.one.p": "7$", "price.one.d": "تشخيص واحد عميق",
    "price.month.t": "شهري", "price.month.p": "12$/شهر", "price.month.d": "5 استشارات شهريًا · بدون إعلانات",
    "price.cta": "ابدأ الآن", "price.popular": "الأكثر شيوعًا",
    "disclaimer": "يقدّم DoctorsCon معلومات تعليمية فقط وليس بديلاً عن المشورة الطبية المهنية.",
  ...
  so: {
    ...
    "price.one.t": "Mar keliya", "price.one.p": "$7", "price.one.d": "Hal baaritaan qoto dheer",
    "price.month.t": "Bil walba", "price.month.p": "$12/bil", "price.month.d": "5 baaritaan bishii · xayaysiis la'aan",
    "price.cta": "Bilow", "price.popular": "Caan",
    "disclaimer": "DoctorsCon waxay bixisaa macluumaad waxbarasho oo keliya, ma aha beddel u dhaqtarka.",
  ...
  am: {
    ...
    "price.one.t": "አንድ ጊዜ", "price.one.p": "$7", "price.one.d": "አንድ ጥልቅ ምርመራ",
    "price.month.t": "ወርሃዊ", "price.month.p": "$12/ወር", "price.month.d": "5 ምርመራ በወር",
    "price.cta": "ጀምር", "price.popular": "ታዋቂ",
    "disclaimer": "DoctorsCon ትምህርታዊ መረጃ ብቻ ይሰጣል፣ የሐኪም ምትክ አይደለም።",
